...
namespace NopMSoft.Plugin.Reports.ProductsWithoutDescription.Services
{
    ...
    public class ProductReportService : IProductReportService
    {
        ...
        /// </returns>
        public Task<IPagedList<Product>> GetWithoutDescriptionReportAsync(int pageIndex = 0, int pageSize = int.MaxValue, IList<int> categoryIds = null, int manufacturerId = 0, string sku = "", int storeId = 0, int vendorId = 0, int warehouseId = 0, ProductType? productType = null, string productName = "", bool? overridePublished = null)
        {
